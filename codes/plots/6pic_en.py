...
ax1.set_title('Original image (carrier)')

ax2 = fig.add_subplot(333)
ax2.imshow(im&1,cmap='binary')
ax2.set_title(u'The LSB planet of the original image')
